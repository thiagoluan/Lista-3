...
int main(void){
    ...
    // chama a função que realiza a soma entre as matrizes
    int **matriz=soma(a, b, n); 
...
// função que realiza a soma entre as matrizes A e B
int **soma(int **a, int **b, int n){ 
    int i, j;
    int **resul;
    ...
    //laço de repetição que passa pelos valores das matrizes e realiza a soma
    for( i=0;i<n;i++){
        for(j=0;j<n;j++){ 
